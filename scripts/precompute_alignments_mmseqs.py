...
from xtrimomultimer.data.tools import hhsearch
...
if __name__ == "__main__":
    ...
    parser.add_argument("uniref_db", type=str, help="Basename of uniref database")
    ...
    if args.hhsearch_binary_path is not None and args.pdb70 is None:
        raise ValueError("pdb70 must be specified along with hhsearch_binary_path")
