...
from xtrimomultimer.model.primitives import Linear, LayerNorm
from xtrimomultimer.model.dropout import DropoutRowwise, DropoutColumnwise
from xtrimomultimer.model.msa import (
    MSARowAttentionWithPairBias,
    MSAColumnAttention,
    MSAColumnGlobalAttention,
)
from xtrimomultimer.model.outer_product_mean import OuterProductMean
from xtrimomultimer.model.pair_transition import PairTransition
from xtrimomultimer.model.triangular_attention import (
    TriangleAttentionStartingNode,
    TriangleAttentionEndingNode,
)
from xtrimomultimer.model.triangular_multiplicative_update import (
    TriangleMultiplicationOutgoing,
    TriangleMultiplicationIncoming,
)
from xtrimomultimer.utils.checkpointing import checkpoint_blocks, get_checkpoint_fn
...
class MSATransition(nn.Module):
    ...
    def _transition(self, m: torch.Tensor, mask: torch.Tensor):
        m = self.linear_1(m)
        m = self.relu(m)
