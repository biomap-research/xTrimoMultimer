...
from xtrimomultimer.model.primitives import LayerNorm, Attention
...
from xtrimomultimer.utils.checkpointing import checkpoint_blocks
...
class TemplatePointwiseAttention(nn.Module):
    ...
    def __init__(
        self, c_t: int, c_z: int, c_hidden: int, no_heads: int, inf: float, **kwargs
    ):
        """
        Args:
            c_t:
