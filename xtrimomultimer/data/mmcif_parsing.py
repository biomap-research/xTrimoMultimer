...
from xtrimomultimer.data.errors import MultipleChainsError
...
def _get_header(parsed_info: MmCIFDict) -> PdbHeader:
    ...
    if "_pdbx_audit_revision_history.revision_date" in parsed_info:
        ...
        logger.warning("Could not determine release_date: %s", parsed_info["_entry.id"])
    ...
    for res_key in (
        ...
        if res_key in parsed_info:
            try:
                ...
                logger.info("Invalid resolution format: %s", parsed_info[res_key])
...
def get_atom_coords(
    ...
    """
    be consistent with deepmind's v2.2.0
    see details from https://github.com/deepmind/alphafold/blob/v2.2.0/alphafold/data/templates.py#L430
    """
