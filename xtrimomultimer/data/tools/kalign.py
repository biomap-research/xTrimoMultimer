...
class Kalign:
    ...
    def align(self, sequences: Sequence[str], base_dir: str = "/tmp/") -> str:
        ...
        with utils.tmpdir_manager(base_dir=base_dir) as query_tmp_dir:
            ...
            # remember to add -q as one of kalign's parameter, otherwise it will raise an exception somtimes.
            cmd = [
                self.binary_path,
                "-i",
                input_fasta_path,
