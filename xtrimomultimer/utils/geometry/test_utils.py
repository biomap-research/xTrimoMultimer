...
from xtrimomultimer.utils.geometry import rigid_matrix_vector
from xtrimomultimer.utils.geometry import rotation_matrix
from xtrimomultimer.utils.geometry import vector
import numpy as np
...
def assert_array_equal_to_rotation_matrix(
    array: np.ndarray, matrix: rotation_matrix.Rot3Array
):
