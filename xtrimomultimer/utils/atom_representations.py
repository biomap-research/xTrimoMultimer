...
from xtrimomultimer.utils import geometry, tensor_utils
import numpy as np
...
def get_rc_tensor(rc_np, aatype: torch.tensor):
...
def atom37_to_atom14(aatype: torch.Tensor, all_atom_pos, all_atom_mask):
...
def get_alt_atom14(aatype: torch.Tensor, positions: torch.Tensor, mask: torch.Tensor):
