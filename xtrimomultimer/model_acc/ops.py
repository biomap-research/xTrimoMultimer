...
from xtrimomultimer.model_acc.kernel import scale_mask_softmax, scale_mask_bias_softmax
from xtrimomultimer.model_acc.kernel import LayerNorm

from xtrimomultimer.model_acc.primitives import glorot_uniform_af

from xtrimomultimer.model_acc.kernel import bias_sigmod_ele
from xtrimomultimer.model_acc.distributed import gather, scatter
...
class SelfAttention(nn.Module):
    ...
    def forward(self, in_data, mask, nonbatched_bias=None):
        ...
        if nonbatched_bias is not None:
            ...
            bias = rearrange(bias, "b q k h -> b h q k").unsqueeze(1)
        ...
        for ax in range(0, para_dim, chunk_size):
            ...
            if nonbatched_bias is not None:
                weights = scale_mask_bias_softmax(logits, mask_part, bias, self.scaling)
            else:
                weights = scale_mask_softmax(logits, mask_part, self.scaling)
