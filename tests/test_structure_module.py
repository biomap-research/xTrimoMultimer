...
from xtrimomultimer.data.data_transforms import make_atom14_masks_np
from xtrimomultimer.np.residue_constants import (
...
import xtrimomultimer.utils.feats as feats
...
class TestStructureModule(unittest.TestCase):
    ...
    def test_structure_module_compare(self):
        ...
        model = compare_utils.get_global_pretrained_xtrimomultimer()
